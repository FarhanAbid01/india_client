...
class ChangeAddressItemWidget extends StatelessWidget {
  ChangeAddressItemWidget(
    this.changeAddressItemModelObj,
    this.index,
  );
  ...
  Widget build(BuildContext context) {
    return Obx(() => GestureDetector(
          onTap: () async {
            ...
            await addresscontroller.defaultAddress(Constant.accessToken,
                changeAddressItemModelObj[index].node?.id ?? "");
            Get.back();
            Get.snackbar(
                "Success", "You have successfully set this address to default",
                  ...
                  onSelected: (value) async {
                    if (value == 1) {
                      Get.to(UpdateAddress(
                          updateModel: changeAddressItemModelObj[index].node,
                          defaultAddress: null));
                    ...
                    if (value == 2) {
                      await addresscontroller.deleteAddress(
                          ...
                          changeAddressItemModelObj[index].node?.id ?? "");
                      changeAddressItemModelObj.removeWhere((element) =>
                          element.node?.id ==
                          changeAddressItemModelObj[index].node?.id);
                    ...
                    if (value == 3) {
                      await addresscontroller.defaultAddress(
                          Constant.accessToken,
                          changeAddressItemModelObj[index].node?.id ?? "");
                    }
                  },
