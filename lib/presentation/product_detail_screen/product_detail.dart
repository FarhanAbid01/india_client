...
class _ProductDetailUpdatesState extends State<ProductDetailUpdates> {
                              ...
                              cartController.addToCartProducts
                                ...
                                if (element.quantity > 0) {
                                  cartController.subTotal =
                                      cartController.subTotal.value.obs +
                                          (double.parse(element.node?.variants
                                                      ?.edges?[0].node?.price ??
                                                  "") *
                                              element.quantity);
                                }
                                                  ...
                                                  .copyWith(
                                                      borderRadius:
                                                          BorderRadiusStyle
                                                              .txtRoundedBorder10),
                                              child: Text(
                                                  "${cartController.addToCartProducts.where((element) => element.quantity > 0).toList().length}",
                                                  overflow:
                        ...
                        Padding(
                          ...
                          child: PageView(
                            ...
                            children: List.generate(
                                widget.productNode?.images?.edges?.length ?? 0,
                                (index) {
                              String model = widget.productNode?.images
                                      ?.edges?[index].node?.src ??
                                  "";
            ...
            child: Column(
              ...
              children: [
                            ...
                            child: Container(
                                child: RichText(
                                    text: TextSpan(children: [
                                      TextSpan(
                                          text:
                                              "Rs.${widget.productNode?.variants?.edges?[0].node?.price}",
                                          style: TextStyle(
                                      ...
                                      TextSpan(
                                          text:
                                              "${widget.productNode?.variants?.edges?[0].node?.compareAtPrice}",
                                          style: TextStyle(
                                              color: ColorConstant.indigo900,
                              ...
                              children: [
                                Expanded(
                                  child: GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        if (cartController.productQty.value >
                                            0) {
                ...
                Container(
                    ...
                    child: Column(
                        ...
                        children: [
                          CustomButton(
                              onTap: () async {
                                if (cartController.addToCartProducts.any(
                                    (element) =>
                                        element.node == widget.productNode)) {
                                  cartController.addToCartProducts
                                      .where(
                                          (p0) => p0.node == widget.productNode)
                                      .first
                                      .quantity = cartController
                                          .addToCartProducts
                                          .where((p0) =>
                                              p0.node == widget.productNode)
                                          .first
                                          .quantity +
                                      cartController.productQty.value;
                                } else {
                                  cartController.addToCartProducts.add(
                                      ProductModel(
                                          node: widget.productNode,
                                          quantity:
                                              cartController.productQty.value));
                                }
                ...
                Container(
                    ...
                    decoration: BoxDecoration(
                        borderRadius:
                            BorderRadius.circular(getHorizontalSize(12.50))),
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisSize: MainAxisSize.max,
                        children: List.generate(tabsList.length,
                            (index) => tabsWidget(tabsList[index], index)))),
                if (selectedTab == 0) ...[
                  Container(
                      width: getHorizontalSize(320.00),
                      margin: getMargin(left: 24, top: 22, right: 24),
                      child: Text(
                          "${widget.productNode?.description?.replaceFirst("Description:", "")}",
                          maxLines: null,
                          textAlign: TextAlign.left,
                          style: AppStyle.txtRobotoRegular14
                              .copyWith(letterSpacing: 0.18, height: 1.43))),
                  Align(
                      ...
                      child: Padding(
                          ...
                          child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                    padding:
                                        getPadding(left: 10, top: 3, bottom: 1),
                    ...
                    child: FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          if (!snapshot.hasData) {
                            ...
                            print(
                                'this is my data ' + snapshot.data.toString());
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Padding(
                                        ...
                                        child: ProductPageItemWidget(
                                            product.data!.collections!.nodes![1]
                                                .products!.edges![index],
                                            product.data!.collections!.nodes![1]
                                                .products!.edges![index].node!),
                                      );
                                    },
                                  ),
                                )
                          ...
                          if (!snapshot.hasData) {
                            ...
                            return SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                shrinkWrap: true,
                                primary: false,
                                itemCount: product.data!.collections!.nodes![1]
  ...
  Widget categoriesTab(String title) {
    return CustomButton(
        width: 118,
        text: title.tr,
        variant: ButtonVariant.FillPink50,
        ...
        child: Column(
          children: [
            Text(title.tr,
                ...
                textAlign: TextAlign.left,
                style:
                    AppStyle.txtRobotoRegular14.copyWith(letterSpacing: 0.18)),
            Container(
              decoration: BoxDecoration(
                  border: Border(
                bottom: BorderSide(
